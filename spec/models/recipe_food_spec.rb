...
RSpec.describe RecipeFood, type: :model do
  subject do
    ...
    recipe = Recipe.new(user: user, name: 'Paella recipe', preparation_time: '15 Minutes',
                         cooking_time: '30 Minutes', description: 'Spanish dish made of spicy rice and sea food',
                         public: true)
    food = Food.new(user: user, name: 'Paella', measurement_unit: 'g', price: 4, quantity: 250)
    RecipeFood.new(recipe: recipe, food: food, quantity: 1)
  end
